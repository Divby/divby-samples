  ...
  return (
    <div className="flex flex-col gap-6">
          ...
          <ul className="flex items-center gap-3">
            {option.choices?.map((choice) => {
              ...
              return option.name === "Color" ? (
                ...
                <li
                  className="ring-1 ring-divby text-divby rounded-md py-1 px-4 text-sm"
                  style={{
                    cursor: disabled ? "not-allowed" : "pointer",
      ...
      {/* <h4 className="font-medium">Choose a size</h4>
            <ul className="flex items-center gap-3">
                <li className="ring-1 ring-divby text-divby rounded-md py-1 px-4 text-sm cursor-pointer">Small</li>
                <li className="ring-1 ring-divby text-white bg-divby rounded-md py-1 px-4 text-sm cursor-pointer">Medium</li>
